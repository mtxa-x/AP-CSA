...
public class CharMatrix {
    ...
    public static void main(String[] args) {
        ...
        matrix.display();
        matrix.setCharAt(1, 1, 'x');
        matrix.display();
        matrix.clearRect(0, 0, 1, 2);
        matrix.display();
        System.out.println("Non-space characters in row 1: " + matrix.countInRow(1));
        System.out.println("Non-space characters in col 1: " + matrix.countInCol(1));
    }
}
